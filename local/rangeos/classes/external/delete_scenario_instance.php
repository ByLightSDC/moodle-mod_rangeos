...
class delete_scenario_instance extends external_api {
    ...
    public static function execute_parameters(): external_function_parameters {
        return new external_function_parameters([
            ...
            'rangeid' => new external_value(PARAM_RAW, 'Range UUID where the scenario is deployed'),
            'scenarioid' => new external_value(PARAM_RAW, 'Scenario instance UUID to delete'),
        ]);
    }

    public static function execute(int $envid, string $rangeid, string $scenarioid): array {
        ...
        $client->delete_scenario_instance($params['rangeid'], $params['scenarioid']);
